...
import torchvision
## 创建文件夹
os.makedirs("./images/gan3/", exist_ok=True)  ## 记录训练过程的图片效果
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            save_image(gen_imgs.data[:25], "images/gan3/%d.png" % batches_done, nrow=5, normalize=True)
## 保存模型
torch.save(generator.state_dict(), './save/gan/generator3.pth')
torch.save(discriminator.state_dict(), './save/gan/discriminator3.pth')