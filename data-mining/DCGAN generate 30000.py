...
generator1.load_state_dict(torch.load("./save/gan/generator3.pth",map_location=device))
generator1.eval()
# generator1.eval()
for i in range(1,30001):
    z = torch.randn(1, 100).to(device)
    fake_image = generator1(z)
    torchvision.utils.save_image(fake_image, "E:/GAN1/imaged/generator_image2/generated%d_image.png" % i)